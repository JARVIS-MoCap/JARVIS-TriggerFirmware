#ifndef _SERIAL_PEER_H // To make sure you don't declare the function more than once by including the header multiple times.
...
public:
    ...
    void sendInputs(uint32_t uptime_us, uint32_t pulse_id, uint8_t inputs_state);
